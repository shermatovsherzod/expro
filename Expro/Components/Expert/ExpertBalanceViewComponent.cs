...
{
    public class ExpertBalanceViewComponent : ViewComponent
    {
        UserManager<ApplicationUser> _userManager;
        public ExpertBalanceViewComponent(UserManager<ApplicationUser> userManager)
        {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            return View("ExpertBalance", vmodel);
        }
    }
}
