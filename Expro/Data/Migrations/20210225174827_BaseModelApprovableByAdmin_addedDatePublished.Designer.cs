...
namespace Expro.Data.Migrations
{
    ...
    [Migration("20210225174827_BaseModelApprovableByAdmin_addedDatePublished")]
    partial class BaseModelApprovableByAdmin_addedDatePublished
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Expro.Models.Feedback", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("FeedbakToUser")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Expro.Models.LocalizationShort", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Expro.Models.RatingUpdate", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("NextUpdateJobID")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Expro.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("DateRatingLastUpdated")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Expro.Models.Feedback", b =>
                {
                    b.HasOne("Expro.Models.ApplicationUser", "Creator")
                        .WithMany("FeedbacksCreatedByThisUser")
                        .HasForeignKey("CreatedBy");
                    ...
                    b.HasOne("Expro.Models.ApplicationUser", "ToUser")
                        .WithMany("FeedbacksWrittenToThisExpert")
